local t = Def.ActorFrame{
	...
	LoadActor(THEME:GetPathG("","_PlayMode/MAX (doubleres).png"))..{
		InitCommand=cmd(halign,0;x,-170;y,42);
	};
	LoadActor(THEME:GetPathG("","_PlayMode/dots.png"))..{
		InitCommand=cmd(x,54;y,42);
	};
	LoadFont("_@apex commercial 20px")..{
		InitCommand=cmd(settext,"EASY";skewx,-0.15;halign,0;y,-35;x,-180;zoom,1.75;zoomy,1.25;diffuse,color("#fbfa3e"));
	};
	LoadFont("_russell square 16px")..{
		...
		OnCommand=cmd(settext,"Enjoy easy songs prepared for beginners!")
	};
	LoadFont("_@apex commercial 20px")..{
